...
L2BCMBT_SWATHS swath300[300];
L2ADPR_SWATHS dprswathT;
L2AKu_NS      L2AKuData;


void setlatlons1t_300_(int *isc,float *lat, float *lon, float *sfcPrecip, 
                  float *sfcPrecipStd, float *piaOut)
{
  int i;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void setlatlons2t_300_(int *isc,float *lat, float *lon, float *sfcPrecip, 
...
void copyrrates1t_300_(int *isc,float *rrate, float *rratestd, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copysflfractt_300_(int *isc,float *lfract, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyzkat_300_(int *isc,float *zka, int *i)
{
  int k;
...
void copypiakat_300_(int *isc,float *piaKa, int *i)
{
  int k;
  extern L2ADPR_SWATHS dprswathT;
...
void copytruerratet_300_(int *isc,float *rrate, int *i)
{
  int k;
  extern L2ADPR_SWATHS dprswathT;
...
//begin  WSO 8/30/13
void copyenvsfqvs1t_300_(int *isc,float *envQv, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyenvsfqvs2t_300_(int *isc,float *envQv, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copyenvqvs1t_300_(int *isc,float *envQv, short *envnodes, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyenvqvs2t_300_(int *isc,float *envQv, short *envnodes, int *i)
{
  int k;
  //extern L2BCMBT_SWATHS swath;
  //for(k=0;k<10;k++)
...
void copyenvpresss1t_300_(int *isc,float *envQv, short *envnodes, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyenvpresss2t_300_(int *isc,float *envQv, short *envnodes, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
  //for(k=0;k<10;k++)
...
void copyenvtemps1t_300_(int *isc,float *envQv, short *envnodes, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyenvtemps2t_300_(int *isc,float *envQv, short *envnodes, int *i)
{
  int k;
  // extern L2BCMBT_SWATHS swath;
  for(k=0;k<10;k++)
...
void copyenvsftemps1t_300_(int *isc,float *envQv, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyenvsftemps2t_300_(int *isc,float *envQv, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copypwcs1t_300_(int *isc,float *rrate, float *rratestd, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
//begin  WSO 8/7/13
void copylwcfracs1t_300_(int *isc,float *mlwc_frac, float *mrate_frac, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copysfcrainliqfracs1t_300_(int *isc,float *sfcrainliq_frac, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyd0s1t_300_(int *isc,float *dm, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyzckus1t_300_(int *isc,float *zc, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copynodess1t_300_(int *isc,int *node, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyrrates2t_300_(int *isc,float *rrate, float *rratestd, int *i)
{
  int k;
  //extern L2BCMBT_SWATHS swath;
...
void copypwcs2t_300_(int *isc,float *rrate, float *rratestd, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
//begin  WSO 8/7/13
void copylwcfracs2t_300_(int *isc,float *mlwc_frac, float *mrate_frac, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copysfcrainliqfracs2t_300_(int *isc,float *sfcrainliq_frac, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copyd0s2t_300_(int *isc,float *dm, int *i)
{
  int k;
  //extern L2BCMBT_SWATHS swath;
...
void copyzckus2t_300_(int *isc,float *zku, float *zka, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copynodess2t_300_(int *isc,int *node, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
  for(k=0;k<5;k++)
...
void rewindt_300_(int *isc,int *ic)
{
...
void rewind_dprt_300_(int *isc,int *ic)
{
  extern TKINFO       dprtkfile;
...
void frominputt_300_(int *isc,long *st_2adpr)
{
...
void copyscantimet_300_(int *isc,int *i)
{
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copypreciptypet_300_(int *isc,int *ptype, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyw10t_300_(int *isc,float *w10, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyw10sigmat_300_(int *isc,float *w10s, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copyw10smallt_300_(int *isc,float *w10, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copyw10smallsigmat_300_(int *isc,float *w10s, int *i)
{
  int k;
  //extern L2BCMBT_SWATHS swath;
...
void write_emptyt_300_(int *isc)
...
void writescant_300_(int *isc)
{
  ...
  if (strncmp(emptygranuletext,"NOT_EMPTY",9) == 0)
      ret= TKwriteScan(&ctkfile,&swath300[*isc]);
}
//  end    SFM  11/27/2013

void copysfcairtemps1t_300_(int *isc,float *sfcVar, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copysfcairtemps2t_300_(int *isc,float *sfcVar, int *i)
{
  int k;
  //extern L2BCMBT_SWATHS swath;
...
void copysfcairpresss1t_300_(int *isc,float *sfcVar, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
  extern L2BCMBT_SWATHS swath300[300];
...
void copysfcairpresss2t_300_(int *isc,float *sfcVar, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copyskintemps1t_300_(int *isc,float *sfcVar, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copyskintemps2t_300_(int *isc,float *sfcVar, int *i)
{  
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copyskintempsigmas1t_300_(int *isc,float *skinsigma, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copyskintempsigmas2t_300_(int *isc,float *skinsigma, int *i)
{  
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copycolumnvaporsigmas1t_300_(int *isc,float *colvaporsigma, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copycolumnvaporsigmas2t_300_(int *isc,float *colvaporsigma, int *i)
{  
  int k;
  // extern L2BCMBT_SWATHS swath;
...
void copycolumncloudliqsigmas1t_300_(int *isc,float *colcldsigma, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copycolumncloudliqsigmas2t_300_(int *isc,float *colcldsigma, int *i)
{  
  int k;
  // extern L2BCMBT_SWATHS swath;
...
void copyalgotypes1t_300_(int *isc,int *algotype, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copyalgotypes2t_300_(int *isc,int *algotype, int *i)
{
  int k;
  //extern L2BCMBT_SWATHS swath;
...
void copyerrorofdatafits1t_300_(int *isc,float *erroroffit, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copyerrorofdatafits2t_300_(int *isc,float *erroroffit, int *i)
{  
  int k;
  //extern L2BCMBT_SWATHS swath;
...
void copysfcemissouts1t_300_(int *isc,float *tbout, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copysfcemissouts1sigmat_300_(int *isc,float *tbout, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
//begin  WSO 10/13/15 change loops to output HF
...
void copysfcemissouts2t_300_(int *isc,float *tbout, int *i)
{
  int k;
  //extern L2BCMBT_SWATHS swath;
//begin  WSO 10/13/15 change loops to output HF
...
void copysfcemissouts2sigmat_300_(int *isc,float *tbout, int *i)
{
  int k;
  // extern L2BCMBT_SWATHS swath;
//begin  WSO 10/13/15 change loops to output HF
...
void copytbouts1t_300_(int *isc,float *tbout, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
//begin  WSO 9/16/13
...
void copytbouts2t_300_(int *isc,float *tbout, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
//begin  WSO 9/16/13
...
void copyrainflags1t_300_(int *isc,int *sfcVar, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copyrainflags2t_300_(int *isc,int *sfcVar, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copyioqualitys1t_300_(int *isc,int *sfcVar, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copyioqualitys2t_300_(int *isc,int *sfcVar, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copysnowices1t_300_(int *isc,int *sfcVar, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copysnowices2t_300_(int *isc,int *sfcVar, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copysfcliqfracts1t_300_(int *isc,float *sfcVar, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copysfcliqfracts2t_300_(int *isc,float *sfcVar, int *i)
{
  int k;
  // extern L2BCMBT_SWATHS swath;
...
void copycldwaters1t_300_(int *isc,float *var1d, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copycldwaters2t_300_(int *isc,float *var1d, int *i)
{
  int k;
  // extern L2BCMBT_SWATHS swath; 
...
void copycldices1t_300_(int *isc,float *var1d, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copycldices2t_300_(int *isc,float *var1d, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copysigmapias1t_300_(int *isc,float *sigmapia, int *i)
{
   extern L2BCMBT_SWATHS swath1;
//diagnostic
...
void copysigmapias2t_300_(int *isc,float *sigmapiaku, float *sigmapiaka, int *i)
{
  //  extern L2BCMBT_SWATHS swath;
//    diagnostic
...
void copyprincomps1t_300_(int *isc,float *princomp, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
//
void copyprincomps2t_300_(int *isc,float *princomp, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
//write profile class
void copyprofclasss1t_300_(int *isc,int *profclass, int *i)
{
  extern L2BCMBT_SWATHS swath1;
...
void copyprofclasss2t_300_(int *isc,int *profclass, int *i)
{
  //  extern L2BCMBT_SWATHS swath;
...
void copysurfprecipbiasratios1t_300_(int *isc,float *biasratio, int *i)
{ 
  extern L2BCMBT_SWATHS swath1;
...
void copysurfprecipbiasratios2t_300_(int *isc,float *biasratio, int *i)
{
  //  extern L2BCMBT_SWATHS swath;
...
void copyinitnws1t_300_(int *isc,float *initlogNw, int *n9, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copyinitnws2t_300_(int *isc,float *initlogNw, int *n9, int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copysubfootvariabilitys1t_300_(int *isc,float *subfoot, int *i)
{ 
  extern L2BCMBT_SWATHS swath1;
...
void copysubfootvariabilitys2t_300_(int *isc,float *subfoot, int *i)
{
  //  extern L2BCMBT_SWATHS swath;
...
void copymultiscatcalcs1t_300_(int *isc,int *multiscat, int *i)
{ 
  extern L2BCMBT_SWATHS swath1;
...
void copymultiscatcalcs2t_300_(int *isc,int *multiscat, int *i)
{ 
  // extern L2BCMBT_SWATHS swath;
...
void copymultiscatsurfaces1t_300_(int *isc,float *multisfc, int *i)
{
  extern L2BCMBT_SWATHS swath1;
...
void copymultiscatsurfaces2t_300_(int *isc,float *multisfc, int *i)
{
  //  extern L2BCMBT_SWATHS swath;
...
void copysigmazeros1t_300_(int *isc,float *sigmazeroku, int *i)
{
  extern L2BCMBT_SWATHS swath1;
  swath300[*isc].NS.Input.sigmaZeroMeasured[*i] = *sigmazeroku;
}
void copysigmazeros2t_300_(int *isc,float *sigmazeroku, float *sigmazeroka, int *i)
{
  //    extern L2BCMBT_SWATHS swath;
...
void copylognws1t_300_(int *isc,float *logNw, int *n9, int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copylognws2t_300_(int *isc,float *logNw, int *n9,int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void copymus1t_300_(int *isc,float *mu_prof, int *n9,int *i)
{
  int k;
  extern L2BCMBT_SWATHS swath1;
...
void copymus2t_300_(int *isc,float *mu_prof, int *n9,int *i)
{
  int k;
  //  extern L2BCMBT_SWATHS swath;
...
void idiot_checkt_300_(int *isc,int *number, char *ident)
{
